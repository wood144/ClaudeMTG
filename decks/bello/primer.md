...
- **Warstorm Surge + token producers**: Each creature entering deals damage equal to its power. Rampaging Baloths tokens deal 4 each.
- **Kodama of the East Tree + permanent chains**: Each permanent entering lets you put another with equal or lesser MV from hand for free. Cast a 6-drop, chain a 5-drop, etc.
- **Grothama + Mosswort Bridge**: Grothama's 10 power enables Bridge's hideaway condition (total power 10+).
- **Rampaging Baloths + land drops**: 4/4 Beast tokens fuel combat and Warstorm Surge triggers.

## Key Cards
- **Bello** (3/3, 1RG): The engine. Animates expensive noncreature permanents into hasty indestructible threats.
- **Warstorm Surge**: Removal + reach. Every creature entering deals damage. Becomes a 4/4 hasty indestructible with Bello.
- **Grothama, All-Devouring** (10/8, 3GG): Massive body, enables Mosswort Bridge. Risk: opponents can fight it and draw cards if it dies.
- **Kodama of the East Tree** (6/6 reach, 4GG): Chains permanents from hand. Reach blocks flyers.
...
- Warstorm Surge was the MVP — animated as 4/4 indestructible hasty, and its triggered damage killed Luminous Broodmoth (10 damage from Grothama entering) and Mirri (4 damage from Beast token).
- Heroic Intervention saved opponent's board from the first Surge trigger (10 damage to Broodmoth fizzled due to hexproof), but only delayed a turn.
- Grothama enabled Mosswort Bridge → cheated in Rampaging Baloths for free.
- T16 Kodama chained Tendershoot Dryad off Primeval Bounty, Harmonize triggered Bounty's +3/+3 counters on Baloths → 36 power on board, lethal through all blocks.
- Opponent's Generous Gift destroyed Warstorm Surge on their turn (not indestructible outside our turn) — only real interaction that stuck.
- **Key lesson:** Bello's indestructible is turn-dependent. Opponent removing Surge on their turn was correct — time removal for opponent's turn.
...
- T2: Sol Ring. T4: Burnished Hart sacrificed for 2 Forests. Ramp online.
- T8: Bello + Llanowar Loamspeaker deployed.
- T10: Warstorm Surge cast, animated as 4/4 indestructible hasty via Bello. Opponent's Heroic Intervention saved board from 10-damage Surge trigger.
- T12: Grothama cast → Surge deals 10 to Broodmoth (dead). Mosswort Bridge activated → Rampaging Baloths free → Surge deals 6 to opponent's face (40→34). 20-damage combat swing (34→14).
- T14: Opponent's Generous Gift destroyed Warstorm Surge on their turn. Bronzehide Lion deployed.
- T16: Kodama cast → Surge trigger kills Broodmoth. Wait, Surge was dead by now. Kodama chains Tendershoot off Primeval Bounty. Harmonize refuels hand + Bounty triggers 3 counters on Baloths (9/9 trample). 36 power on board, lethal through all blocks. Opponent concedes.
